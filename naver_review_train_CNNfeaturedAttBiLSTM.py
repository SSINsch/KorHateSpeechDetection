...
from naver_review_data_loader import get_loader
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epoch):
        ...
        for step, (x_comment_tokenized, padded_word_tokens_matrix,
            ...
            # 모델에 입력
            pred = cnn_feat_att_bilstm_model(padded_word_tokens_matrix, padded_char_tokens_matrix)
        ...
        for step, (test_x_comment_tokenized, test_padded_word_tokens_matrix,
            ...
            pred = cnn_feat_att_bilstm_model(test_padded_word_tokens_matrix, test_padded_char_tokens_matrix)
