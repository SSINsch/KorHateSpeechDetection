...
if __name__ == "__main__":
    ...
    for epoch in range(num_epoch):
        bilstm_model.train()
        for step, (x_comment_tokenized, padded_word_tokens_matrix, _, _, y_hate_item) in enumerate(data_loader):
            # gpu 로 보내고
            ...
            # 모델에 입력
            pred = bilstm_model(padded_word_tokens_matrix)
        ...
        for step, (test_x_comment_tokenized, test_padded_word_tokens_matrix,
                   _, _, test_y_hate_item) in enumerate(test_loader):
            # gpu 로 보내고
            ...
            pred = bilstm_model(test_padded_word_tokens_matrix)
